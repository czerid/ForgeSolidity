// src/lib.rs
/*
 * Core library for ForgeSolidity
 */
...
#[derive(Debug)]
pub struct ForgeSolidityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ForgeSolidityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ForgeSolidity processing");
    
    let mut processor = ForgeSolidityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ForgeSolidityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ForgeSolidityProcessor::new(false);
